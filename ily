...
<head>
    ...
    <style>
        ...
        :root {
            --primary-color: #ff3870; /* Deep Rose Pink */
            --secondary-color: #ffccda; /* Light Pink */
            --text-dark: #2c3e50;
            --text-light: #ecf0f1;
        ...
        .time-unit:hover {
            ...
            background: #ffb6c1; /* Deeper hover color */
        }
...
<body>
        ...
        <section id="memories">
            ...
            <div class="photo-container">
                ...
                <div class="photo-card">
                    ...
                    <div class="caption">
                        "Momen di mana semuanya dimulai. Mataku hanya tertuju padamu sejak detik itu. Terima kasih sudah menjadi rumah bagiku."
                    </div>
                </div>
                ...
                <div class="photo-card">
                    ...
                    <div class="caption">
                        "Saat kita berpetualang di [Sebutkan Tempatnya]. Melihatmu tertawa bebas adalah melodi favoritku. Selamanya mencintaimu!"
                    </div>
                </div>
    ...
    <script>
        ...
        const updateCountdown = () => {
            ...
            // Perhitungan menggunakan objek Date untuk akurasi kalender (Tahun, Bulan, Hari)
            ...
            // Tampilkan hasil dan pastikan selalu dua digit (00)
